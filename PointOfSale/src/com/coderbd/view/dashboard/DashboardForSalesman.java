 ...
 * @author Instructor
 */
public class DashboardForSalesman extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DashboardForSalesman.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
