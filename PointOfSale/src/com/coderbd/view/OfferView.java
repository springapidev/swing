 ...
 * @author Instructor
 */
public class OfferView extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OfferView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
