...
import com.coderbd.lms.service.SessonService;
 ...
 * @author Rajail Islam
 */
public class LmsSesson extends javax.swing.JFrame {

    Sesson sesson;
    SessonService sessonService;
    ...
    private void initComponents() {
        ...
        txtSessonName = new javax.swing.JTextField();
        ...
        tblShowSesson = new javax.swing.JTable();
        ...
        setTitle("Sesson | Library Management System");
        ...
        jLabel4.setText("Sesson Name:");

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(0, 204, 0));
        jLabel3.setText("Create Sesson");
        ...
        tblShowSesson.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tblShowSesson.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblShowSessonMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tblShowSesson);
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(btnDel))
                            .addComponent(txtSessonName, javax.swing.GroupLayout.DEFAULT_SIZE, 173, Short.MAX_VALUE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(txtSessonName, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        String name = txtSessonName.getText();

        sesson=new Sesson(txtSessonName.getText());
        sessonService=new SessonService();
        sessonService.save(sesson);
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        int row=tblShowSesson.getSelectedRow();
        TableModel model=tblShowSesson.getModel();
        sesson.setId(Integer.parseInt((model.getValueAt(row, 0)).toString()));
        
        sessonService.update(sesson);
        lblMsg.setText("1 Record Successfully Saved!");
    ...
    private void btnDelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDelActionPerformed
        ...
        sessonService.delete(sesson.getId());
    ...
    private void tblShowSessonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblShowSessonMouseClicked
        // TODO add your handling code here:
        
        int row=tblShowSesson.getSelectedRow();
        TableModel model=tblShowSesson.getModel();
        
        txtSessonName.setText((model.getValueAt(row, 1)).toString());
        
    }//GEN-LAST:event_tblShowSessonMouseClicked

    public void displayDatasWithinTable() {
        sessonService=new SessonService();
        List<Sesson> pList = sessonService.getList();
        DefaultTableModel model = (DefaultTableModel) tblShowSesson.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LmsSesson.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tblShowSesson;
    private javax.swing.JTextField txtSessonName;
