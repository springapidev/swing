...
import com.coderbd.lms.service.DepartmentService;
 ...
 * @author Rajail Islam
 */
public class LmsDepartment extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblShowDepartment = new javax.swing.JTable();
        ...
        jLabel3.setText("Create Department");
        ...
        tblShowDepartment.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tblShowDepartment.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblShowDepartmentMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tblShowDepartment);
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        departmentService=new DepartmentService();
        int row=tblShowDepartment.getSelectedRow();
        TableModel model=tblShowDepartment.getModel();
        department.setId(Integer.parseInt(model.getValueAt(row, 0).toString()));
    ...
    private void tblShowDepartmentMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblShowDepartmentMouseClicked
        // TODO add your handling code here:
    ...
    }//GEN-LAST:event_tblShowDepartmentMouseClicked
     ...
     public void displayDatasWithinTable() {
        departmentService = new DepartmentService();
        List<Department> pList = departmentService.getList();
        DefaultTableModel model = (DefaultTableModel) tblShowDepartment.getModel();
   ...
   public void refreshTable() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LmsDepartment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tblShowDepartment;
