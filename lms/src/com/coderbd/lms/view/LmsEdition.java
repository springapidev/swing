 ...
 * @author Rajail Islam
 */
public class LmsEdition extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Edition | Library Management System");
        ...
        jLabel3.setText("Add Edition");

        jLabel4.setText("Edition Name");
    ...
    public void displayDatasWithinTable() {
        service = new EditionService();
        List<Edition> pList = service.getList();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LmsEdition.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
