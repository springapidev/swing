...
import com.coderbd.lms.service.ShiftService;
 ...
 * @author Rajail Islam
 */
public class LmsShift extends javax.swing.JFrame {

    private ShiftService as;
    ...
    private void initComponents() {
        ...
        txtEnding = new javax.swing.JTextField();
        ...
        setTitle("Shift | Library Management System");
        ...
        tblDisplay.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Shift Name", "Starting Time", "Ending Time", "Status"
            }
        ));
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(txtEnding, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 149, Short.MAX_VALUE)
                                .addComponent(txtStartingTime, javax.swing.GroupLayout.DEFAULT_SIZE, 149, Short.MAX_VALUE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(rTrue)
                                .addGap(18, 18, 18)
                                .addComponent(rfalse))
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(12, 12, 12)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(txtEnding, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel7))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(rfalse)
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        String startingTime = txtName.getText();
        String endingTime = txtName.getText();
        String status = "";
        if (rfalse.isSelected()) {
            status = rfalse.getText();
        } else {
            status = rTrue.getText();
        }

        Shift user = new Shift(name, startingTime, endingTime, status);
        as = new ShiftService();
        as.save(user);
    ...
    private void tblDisplayMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDisplayMouseClicked
        ...
        txtStartingTime.setText(model.getValueAt(i, 2).toString());
        txtEnding.setText(model.getValueAt(i, 3).toString());
    ...
    public void displayDatasWithinTable() {
        ...
        for (int i = 0; i < pList.size(); i++) {
            ...
            row[2] = pList.get(i).getStartingTime();
            row[3] = pList.get(i).getEndingTime();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LmsShift.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField txtEnding;
